...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-[var(--bg-primary)]/80 backdrop-blur-xl py-6 border-b border-[var(--card-border)] mb-8 md:mb-12 -mx-2 px-2">
      <div className="flex items-center justify-between">
        
        {/* LOGO: The Group Hover Reveal Effect */}
        <div className="flex items-center gap-2">
          <Link 
            to="/" 
            onClick={closeMenu} 
            className="text-2xl font-bold tracking-tighter flex items-center group cursor-pointer" 
            style={{ fontFamily: '"Space Grotesk", sans-serif' }}
          >
            <span>J</span>
            {/* These letters are hidden (max-w-0) but expand smoothly on group hover */}
